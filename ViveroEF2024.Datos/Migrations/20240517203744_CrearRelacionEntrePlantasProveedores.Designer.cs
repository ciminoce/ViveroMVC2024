...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ViveroEF2024.Entidades.ProveedorPlanta", b =>
                {
                    b.Property<int>("ProveedorId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProveedorId", "PlantaId");

                    b.HasIndex("PlantaId");

                    b.ToTable("ProveedoresPlantas");
                });
            ...
            modelBuilder.Entity("ViveroEF2024.Entidades.ProveedorPlanta", b =>
                {
                    b.HasOne("ViveroEF2024.Datos.Planta", "Planta")
                        .WithMany("ProveedoresPlantas")
                        .HasForeignKey("PlantaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ViveroEF2024.Entidades.Proveedor", "Proveedor")
                        .WithMany("ProveedoresPlantas")
            ...
            modelBuilder.Entity("ViveroEF2024.Datos.Planta", b =>
                {
                    b.Navigation("ProveedoresPlantas");
                });
